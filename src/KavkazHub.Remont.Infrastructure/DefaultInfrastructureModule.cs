using Autofac;
using KavkazHub.Remont.Core;
using KavkazHub.Remont.Core.Interfaces;
using KavkazHub.Remont.Infrastructure.Data;
using KavkazHub.Remont.Infrastructure.DomainEvents;
using KavkazHub.Remont.SharedKernel.Interfaces;
using System.Collections.Generic;
using System.Reflection;
using Module = Autofac.Module;

namespace KavkazHub.Remont.Infrastructure
{
